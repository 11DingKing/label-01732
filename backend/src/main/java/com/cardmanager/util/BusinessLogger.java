...
public class BusinessLogger {
     ...
     * 记录批量核销操作日志
     */
    public static void logBatchCardVerify(int successCount, int failCount, Long operatorId, String operatorName) {
        setMDC(operatorId, operatorName);
        BUSINESS_LOG.info("[批量核销] 成功={}, 失败={}, 操作员ID={}, 操作员={}", 
            successCount, failCount, operatorId, operatorName);
        clearMDC();
    }
